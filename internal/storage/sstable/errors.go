// Package sstable implements RivetDB's immutable sorted-table format.
package sstable
...
var (
	...
	ErrUnsupportedVersion = errors.New("unsupported SSTable format version or feature")
	ErrInvalidHandle      = errors.New("invalid SSTable block handle")
	ErrInvalidBlock       = errors.New("invalid SSTable block")
	ErrClosed             = errors.New("SSTable reader is closed")
	ErrNotFound           = errors.New("SSTable entry not found")
	ErrInvalidRange       = errors.New("invalid SSTable user-key range")
	ErrResourceLimit      = errors.New("SSTable reader resource limit exceeded")
)
