...
var (
	...
	ErrMigrationInProgress = errors.New("multiraft: replica migration in progress")
	ErrMigrationConflict   = errors.New("multiraft: conflicting replica migration")
	ErrReplicaRemoved      = errors.New("multiraft: replica removed")
